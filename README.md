<img width="1919" height="931" alt="image" src="https://github.com/user-attachments/assets/65116bb7-79d6-413a-b299-741bbe6645ee" /># ecommerce-sql-analytics
End-to-end SQL analysis of 100K+ Brazilian e-commerce orders — CTEs, Window Functions, RFM &amp; Cohort Analysis
 E-Commerce SQL Analytics — Olist Dataset

 Project Overview

End-to-end SQL analysis of 100,000+ real Brazilian e-commerce orders across 9 tables using advanced SQL techniques.
...
* office_furniture = lowest rated category at 3.49★
...
| 03_customers.sql   | One-time vs repeat, NTILE spend quartiles             |
